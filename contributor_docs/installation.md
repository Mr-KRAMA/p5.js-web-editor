...
1. Install Node.js. The recommended way is to Node through [nvm](https://github.com/nvm-sh/nvm). You can also install [node.js](https://nodejs.org/download/release/v16.14.2/) version 16.20.2 directly from the Node.js website. To check if you already have Node installed on your computer, run `$ node -v`.
